    ...
    <div id="sidebar-container" class="bg-dark">
        ...
        <ul>
            ...
            <ul class="acciones-show">
                <li><a id="link_modificar_articulo" href="{{ route('inventario.mantenimiento_productos') }}" class="d-block text-white p-1 sub_menu_inventario">Mantenimiento artículos</a></li>
